...
#define IDM_OPTIONS_GETTOPIC            608
#define IDM_OPTIONS_OPENPRIVATE         609
#define IDM_OPTIONS_JOINCHANNEL         610
#define IDM_OPTIONS_CONNECT             611
